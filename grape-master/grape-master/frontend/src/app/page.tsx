...
import { Grape, ArrowRight, Sprout, Store, Leaf, ShoppingBag, CheckCircle, Star } from 'lucide-react'
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <RoleCard role="CUSTOMER" title="Customer" icon={<ShoppingBag />}
            ...
            img="https://source.unsplash.com/1200x500/?fresh,vegetables,market" color="ink" />
        </div>
      </section>
      ...
      <section className="bg-vine-soft py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            {[
              ['01', 'Farmer lists', 'Post crop details, quantity, and asking price in under 2 minutes.', 'https://source.unsplash.com/300x200/?farmer,mobile'],
              ['02', 'Broker bids', 'Brokers compete with transparent offers. No back-channel negotiation.', 'https://source.unsplash.com/300x200/?market,trader'],
              ['03', 'Deal confirmed', 'Farmer accepts. Produce moves to broker inventory instantly.', 'https://source.unsplash.com/300x200/?handshake,deal'],
              ['04', 'Payment & receipt', 'PhonePe payment. Automatic transaction record and PDF receipt.', 'https://source.unsplash.com/300x200/?payment,phonepe'],
        ...
        <div className="overflow-hidden rounded-2xl bg-ink text-white">
          <div className="grid md:grid-cols-2">
            ...
            <div className="relative h-64 overflow-hidden md:h-auto">
              <img src="https://source.unsplash.com/600x500/?ai,agriculture,technology" alt="ML recommendations" className="absolute inset-0 h-full w-full object-cover opacity-60" />
            </div>
          </div>
        </div>
      </section>
            ...
            {[
              ...
              <div key={t.name} className="rounded-card border border-line bg-white p-6 shadow-card">
                ...
                <div className="mt-4 flex items-center gap-3">
                  <div className="h-10 w-10 overflow-hidden rounded-full bg-vine-soft">
                    <img src={`https://source.unsplash.com/40x40/?farmer,${t.name.split(' ')[0]}`} alt={t.name} className="h-full w-full object-cover" />
                  </div>
                  <div>
