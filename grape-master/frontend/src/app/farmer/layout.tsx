'use client'
import { LayoutDashboard, Sprout, Inbox, ShoppingCart, Leaf, PackageCheck } from 'lucide-react'
...
const nav: NavItem[] = [
  ...
  { href: '/farmer/orders', label: 'My Orders', icon: <PackageCheck className="h-4 w-4" /> },
]
