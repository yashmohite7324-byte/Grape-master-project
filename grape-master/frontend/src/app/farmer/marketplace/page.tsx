                ...
                <div className="p-4">
                  ...
                  {p.inventory && (
                    <p className="mb-3 text-xs text-muted">
                      <span className="font-mono text-ink">{Array.isArray(p.inventory) ? (p.inventory[0]?.availableQuantity ?? 0) : ((p.inventory as any)?.availableQuantity ?? 0)}</span> {p.unit} available
                    </p>
                  )}
                  <Button
